...
L["Adds a bar inside the health bar indicating how much damage will be absorbed."] = "생명력 바 내부에 흡수되는 피해량을 나타내는 바를 추가합니다."
L["Adds a bar inside the health bar indicating how much healing someone will receive."] = "누군가 받을 치유량을 나타내는 바를 생명력 바 내부에 추가합니다."
L["Adds a bar inside the health bar indicating how much healing will be absorbed and not applied to the player."] = "생명력 바 내부에 흡수되어 플레이어에게 적용되지 않는 치유량을 나타내는 바를 추가합니다."
...
L["Short classifications, R for Rare, R+ for Rare Elite, + for Elite, B for Boss or M for Minion nothing is shown if they aren't any of those."] = "짧은 분류로 희귀는 R, 희귀 정예는 R+, 정예는 +, 우두머리는 B, 소환수는 M이며 이 중 하나가 아닌 경우 아무것도 표시되지 않습니다."
...
L["Units classification, Rare, Rare Elite, Elite, Boss or Minion nothing is shown if they aren't any of those."] = "유닛 분류로 희귀, 희귀 정예, 정예, 우두머리 또는 소환수이며 이 중 하나가 아닌 경우 아무것도 표시되지 않습니다."
...
L["When the unit is mising health, the [missinghp] tag is shown, when they are at full health then the [name] tag is shown. This lets you see -1000 when they are missing 1000 HP, but their name when they are not missing any."] = "유닛의 체력이 감소 할 때, [missinghp] 태그가 보여질 때, 체력이 가득차 있을때에는 [name] 태그가 보여집니다. -1000이 보이면 1000의 HP가 줄어든것입니다. 하지만 그들의 이름은 계속 보일것입니다."
