...
local L = {}
L["%d auras in group"] = "%d 組光環"
L["%s (%s): %s/%s (%.2f%% done)"] = "%s (%s): %s/%s (%.2f%% 已完成)"
L["%s aura groups disabled"] = "%s 光環組禁用"
L["%s frames"] = "%s框架"
L["%s member"] = "%s成員"
...
L["Absolute damage absorption value on the unit, if 10,000 damage will be absorbed, it will show 10,000."] = "在單位上顯示傷害吸收的絕對值，如果10000的傷害被吸收，將會顯示為10000。"
L["Absolute heal absorb value, if 16,000 healing will be absorbed, it will show 16,000."] = "治療量吸收絕對值, 如果16000的治療量被吸收, 顯示為16000."
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "顯示完整的治療量，如10,000治療量則顯示為10,000。"
L["Add"] = "新增"
L["Add Aura"] = "添加光環"
L["Add aura"] = "添加光環"
L["Add Indicator"] = "添加標記"
L["Add link"] = "添加連結"
L["Add new indicator"] = "添加新標記"
L["Add new tag"] = "新增新標籤"
...
L["Adds a bar indicating how much time is left on your Rune of Power."] = "新增狀態條在你的符文能量剩餘多少時間。"
...
L["Adds a bar inside the health bar indicating how much healing will be absorbed and not applied to the player."] = "在生命條裡增加一條用於顯示有多少治療量被吸收而沒有作用於玩家身上."
...
L["Adds a Stagger bar for Brewmaster Monks."] = "為釀酒武僧增加一個醉仙緩勁條(Stagger bar)"
...
L["Aggro"] = "獲得仇恨"
L["All aura groups enabled for unit."] = "啟用此單位所有光環"
L["All Auras"] = "所有光環"
L["Allows you to anchor the aura group to another, you can then choose where it will be anchored using the position.|n|nUse this if you want to duplicate the default ui style where buffs and debuffs are separate groups."] = "允許你定位錨點光環組到另一個, 然後可以選擇要使用的錨點位置.|n|n你可以使用這個來複製那些在Buff和Debuff在不同分組的默認UI樣式."
L["Allows you to disable the totem by right clicking it.|n|nWarning: Inner bars for this unit will not resize in combat if you enable this."] = "允許你通過右擊它禁用圖騰.|n|n警告：本單位內的項目條將不會在戰鬥中調整，如果你啟用這個功能。"
L["Allows you to enter a new aura group."] = "允許你建立一個新的光環組"
L["Alpha to use for bar backgrounds."] = "計量條背景使用的透明度。"
L["Alpha to use for bar."] = "計量條使用的透明度。"
L["Alt. Power"] = "特殊能量"
L["Alt. Power bar"] = "替代的能量條"
L["Alternate power is used for things like quests and dungeons."] = "替代能量被任務和地城來使用。"
L["Alternate Spell Name"] = "備用的法術名稱"
L["Alternatively friendly spell to use to check range."] = "另外的友方法術用來檢查範圍。"
L["Ammo"] = "彈藥"
...
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is."] = "缺損能量值的總數，如果沒有損失則不顯示。使用簡化格式-13850顯示為-13.8k，低於10000的能量值則不簡化。"
L["Anchor point"] = "定位處"
L["Anchor to"] = "定位到"
L["Anchor to another frame"] = "定位到其他框架"
L["Anchor to buffs"] = "定位到增益"
L["Anchor to debuffs"] = "定位到減益"
L["Ancient Kings bar"] = "遠古諸王條(聖能條)Ancient Kings bar"
L["Any auras shown in this indicator will have their total stack displayed."] = "在這個標記裡顯示的光環將會顯示它們總的疊加數"
L["Aquatic"] = "水棲"
L["Arcane Charges"] = "祕法充能"
L["Are you sure you want to delete this aura?"] = "你確定要刪除這光環?"
L["Are you sure you want to delete this filter?"] = "你確定你要刪除這個篩選?"
L["Are you sure you want to delete this indicator?"] = "你確定要刪除這標記?"
...
L["Aura groups"] = "光環組"
L["Aura Groups"] = "光環組"
L["Aura Indicators"] = "光環標記"
L["Aura indicators"] = "光環標記"
L["Aura types to filter"] = "篩選光環類型"
L["Auras"] = "光環"
L["Auras matching a criteria will automatically show up in the indicator when enabled."] = "當啟用後，滿足條件的光環將自動顯示在這個標記中"
...
L["Bar alpha"] = "計量調透明度"
L["Bar color to use to show how much healing someone is about to receive."] = "條顏色用來顯示某人收到了多少的治療。"
L["Bar spacing"] = "計量條間隔"
L["Bar texture"] = "背景材質"
L["Bars"] = "計量條"
L["Bars with an order higher or lower than the full size options will use the entire unit frame width.|n|nBar orders between those two numbers are shown next to the portrait."] = "項目條順序高於或低於全尺寸選項會使用整個單位框架的寬度. |n|n條顯示在兩個數字之間的頭像旁."
L["Battleground"] = "戰場"
...
L["Border color"] = "邊框顏色"
L["Border coloring of stealable, curable and dispellable auras."] = "著色可偷取、可治愈和可驅散的可處理光環邊框"
L["Border highlighting"] = "邊框高亮"
L["Border thickness"] = "邊框厚度"
L["Boss"] = "首領"
L["Boss Auras"] = "首領光環"
L["Boss Debuffs"] = "首領減益(Debuff)"
L["Boss Target"] = "首領目標"
...
L["Changes this widget into a bar, you will be able to change the height and ordering like you can change health and power bars."] = "變更這個小設定到計量條，你可以像修改生命條和能量值那樣修改高度和排列。"
L["Channelling"] = "引導性"
L["Checking this will show the indciator on hostile units."] = "顯示敵對單位標記"
L["Checking this will show the indicator on friendly units."] = "此項將會檢查並在友好單位上顯示標記"
L["Chi"] = "氣"
L["Chi Points"] = "氣點數"
...
L["Color to use to show how much damage will be absorbed."] = "顏色用來顯示有多少傷害被吸收了。"
L["Color to use to show how much healing will e absorbed."] = "用顏色顯示多少治療量會被吸收"
...
L["Current and maximum power, formatted as [curpp]/[maxpp]."] = "當前和最大能量值，格式為[curhp]/[maxhp]。"
...
L["Current pet used by a battleground unit."] = "當前寵物框架將應用到戰場單位"
...
L["Current power, uses a short format, 12750 is formatted as 12.7k, values below 10000 are formatted as is."] = "當前能量值，使用簡化格式12750顯示為12.7k，低於10000的能量值則不簡化。"
...
L["Damage absorption (Short)"] = "吸收傷害(縮寫)"
L["Damage absorption/Name"] = "吸收傷害/名字"
L["Dark"] = "暗色"
L["Dead"] = "死亡"
L["Debuffs"] = "減益"
...
L["Dismissable Totem bars"] = "可解除(Dismissable)圖騰列"
...
L["Due to the nature of fake units, cast bars for %s are not super efficient and can take at most 0.10 seconds to notice a change in cast."] = "由於假單位的性質，%s的施法條不是超級有效率，最多只能注意到0.10秒施法的改變。"
L["Edge size"] = "邊緣大小"
L["Edit tag"] = "編輯標籤"
L["Editing %s"] = "正在編輯%s"
L["Elite"] = "精英"
...
L["Ghost"] = "靈魂"
L["Global"] = "總體"
L["Global configurating will let you mass enable or disable aura groups for multiple units at once."] = "全局設定將會讓你同時為大量單位啟用或禁用光環組"
...
L["Has Aggro"] = "引起仇恨"
L["Heal absorb"] = "吸收治療"
L["Heal Absorb (Absolute)"] = "吸收治療(完整值)"
L["Heal Absorb (Short)"] = "吸收治療(縮寫)"
L["Heal absorbs"] = "吸收治療"
...
L["How many seconds between updates.|n[WARNING] By setting the frequency to 0 it will update every single frame redraw, if you want to disable frequent updating uncheck it don't set this to 0."] = "需要多少秒更新。|n[警告]通過設定頻率為0，它會更新重繪每個幀頻，如果你想禁止頻密的更新，取消這選項並且不要設置為0。"
...
L["Icon Size"] = "圖示尺寸"
L["If multiple auras are shown in the same indicator, the higher priority one is shown first."] = "如果同時多個光環顯示在一個標記中，將顯示優先度的第一的"
L["If name is entered, it must be exact as it is case sensitive. Alternatively, you can use spell id instead."] = "如果已名字輸入的必須是準確到一字不差(如果使用法術英文名稱更必需大階小階都符合)。或者你可以使用法術ID來代替。"
...
L["Indicator this aura should be displayed in."] = "這個光環標記要顯示在"
L["Indicators"] = "標記"
L["Insanity"] = "瘋狂"
L["Inset"] = "插入"
L["Inside Bottom Left"] = "内部靠左下方"
L["Inside Bottom Right"] = "内部靠右下方"
...
L["Main Assists's are set by the Blizzard Main Assist system or mods that use it."] = "主助攻的設置是由暴雪主助理系統或由修改自它來實現。"
L["Main Tank"] = "主坦克"
L["Main Tank Target"] = "主坦克目標"
L["Main Tank Target of Target"] = "主坦克目標的目標"
L["Main Tank's are set through the Raid frames, or through selecting the Tank role."] = "主坦克設定是通過團隊介面，或者通過選擇坦克角色設定。"
L["Male"] = "男性"
L["Mana"] = "法力"
...
L["Name of a friendly spell to check range."] = "友方法術的名稱以檢查距離。"
L["Neutral"] = "中立"
L["Never (Disabled)"] = "從不(停用)"
L["New aura group"] = "新的光環組"
L["New filter"] = "新篩選"
L["None"] = "無"
...
L["Only auras you specifically cast will be shown."] = "只顯示你特定的施放光環。"
...
L["Percentage value of how far outside the unit frame the absorbed health bar can go. 130% means it will go 30% outside the frame, 100% means it will not go outside."] = "允許治療吸收條跑出單位框架的百分率。130%表示會跑出單位框架30％，100％表示不會跑出框架。"
...
L["Returns text based on the units general threat situation: Aggro for Aggro, High for being close to taking aggro, and Medium as a warning to be wary.|nThis cannot be used on target of target or focus target types of units."] = "基於單位一般威脅的情況返回的文字：Aggro(仇恨)你成為被仇恨目標，High(高)仇恨值很高快成為目標和Medium(中)小心仇恨值正在上升。|n這不能在目標單位的目標和焦點目標類型的使用。"
...
L["Returns the color code for the units threat situation in general: Red for Aggro, Orange for High threat and Yellow to watch out.|nThis cannot be used on target of target or focus target types of units."] = "顯示單位的仇恨值的顏色代碼:紅色成為仇恨目標, 橘紅色為高仇恨, 黃色為小心仇恨.|n這個不能被用作目標的目標或焦點的目標等類型單位."
L["Returns the scaled threat percentage for the unit, if you put this on a party member you would see the percentage of how close they are to getting any from any hostile mobs. Always 0 - 100%.|nThis cannot be used on target of target or focus target types of units."] = "顯示單位的可縮放的仇恨值百分比, 如果你將這個放到一個小隊成員身上你將看到他們對任何敵對怪物的仇恨百分比. 百分比在0-100%之間.|n這個不能被用作目標的目標或焦點的目標等類型單位."
...
L["Select the units that you want to modify, any settings changed will change every unit you selected. If you want to anchor or change raid/party unit specific settings you will need to do that through their options.|n|nShift click a unit to select all/unselect all."] = "選擇你想要更改的單位, 任何設置的改變都會改變你已選擇的單位. 如果你想要錨點定位或修改團隊/小隊單位的特定設置你需要通過他們的選項的實現.|n|nShift +點擊一個單位來選擇全部或反選全部."
...
L["Shorten damage absorption, if 13,000 damage will e absorbed, it will show 13k."] = "縮寫傷害吸收，如果13,000的傷害被吸收，將會顯示為13K。"
L["Shorten heal absorb value, if 17,000 healing will be absorbed, it will show 17k."] = "簡化治療吸收值，如果17000的治療量被吸收，則顯示為17K。"
L["Shorten incoming heal value, if 13,000 healing is incoming it will show 13k."] = "縮寫治療量，如13,000治療量顯示為13k。"
...
L["Show boss debuffs"] = "顯示Boss Debuff (減益)"
...
L["Show casted by boss"] = "顯示boss的施法"
L["Show curable debuffs"] = "顯示可被治療的Debuffs (減益)"
L["Show curable/removable auras"] = "顯示可治療/可驅散的光環"
...
L["Shows a bar for alternate power info (used in some encounters)"] = "顯示替代的能量條資訊(在某些遭遇中使用)"
L["Shows a cooldown wheel on the indicator with how much time is left on the aura."] = "於標記上顯示冷卻輪提示還有多長時間光環結束冷卻"
...
L["Shows current and maximum power in absolute form, 18000 power will be showed as 18000 power."] = "顯示完整當前和最大能量值，18000的能量值顯示為18000。"
...
L["Shows current power value in absolute form, 15000 power will be displayed as 1500 still."] = "顯示完整當前能量值，15000的能量值顯示為15000。"
L["Shows debuffs cast by a boss."] = "顯示由Boss施放的Debuff(減益)"
L["Shows debuffs that you can cure."] = "顯示你能夠治愈的Debuff(減益)"
...
L["Shows maximum power in absolute form, 13000 power is showed as 13000 power."] = "顯示完整最大能量值，143000能量值顯示為13000。"
...
L["Shows the absolute staggered damage, if 16,000 damage is staggered, shows 16,000."] = "顯示醉拳化解傷害的絕對值，如果化解了16000的傷害，顯示為16000。"
L["Shows the current staggered damage, if 12,000 damage is staggered, shows 12k."] = "顯示醉拳當前化解的傷害，如果化解了12000的傷害，顯示為12k 。"
...
L["Solid color to use in the indicator, only used if you do not have use aura icon enabled."] = "使用純色標記，僅作用於你沒有啟用顯示光環圖示選項"
L["Sort method"] = "分類方式"
L["Sort order"] = "分類排列"
L["Sorting"] = "分類"
L["Soul Shards"] = "靈魂裂片"
...
L["Spell Name"] = "法術名稱"
L["Spell Name/ID"] = "法術 名稱/ID"
L["Spell you want to link to a primary aura, the casing must be exact."] = "法術將會要連結到主光環，必須準確無誤"
L["Splits raid frames into individual frames for each raid group instead of one single frame.|nNOTE! You cannot drag each group frame individualy, but how they grow is set through the column and row growth options."] = "為每個團隊隊伍分割團隊框體到單獨的框體.|n請注意! 你不能拖曳單獨的每個隊伍框體, 但可以通過在行和列增長選項中設置他們的增長方向."
L["Stagger"] = "醉仙緩勁"
L["Stagger (Monk)"] = "醉仙緩勁 (武僧)"
L["Stagger (Monk/Absolute)"] = "醉仙緩勁 (武僧/絕對值)"
L["Stagger bar"] = "醉仙緩勁條"
L["Stagger bar color when the staggered amount is <30% of your HP."] = "當你的生命值<30%時,醉仙緩勁條的顏色"
L["Stagger bar color when the staggered amount is >30% of your HP."] = "當你的生命值>30%時,醉仙緩勁條的顏色"
L["Stagger bar color when the staggered amount is >70% of your HP."] = "當你的生命值>70%時,醉仙緩勁條的顏色"
L["Static"] = "休息"
L["Statue"] = "雕像"
L["Statue bar"] = "雕像條"
L["Status"] = "狀態"
...
L["Stealable/Curable/Dispellable"] = "可偷取/可治療/可驅散"
...
L["Tags"] = "標籤"
L["Talent spec of your arena opponents."] = "競技場上你的對手專精配置"
L["Target"] = "目標"
...
L["The unit frames you see are examples, they are not perfect and do not show all the data they normally would.|n|nYou can hide them by locking them through /shadowuf or clicking the button below."] = "你看到的頭像僅是例子, 他們不是那麼完美並且不會顯示應該顯示的所有數據.|n|n你可以通過命令行/shadowuf或點擊下面的按鈕鎖定來隱藏他們."
...
L["Unchecking this will completely disable aura indicators for %s."] = "不選擇此項光環標記將會完全禁用於%s"
...
L["Units classification, Rare, Rare Elite, Elite, Boss or Minion nothing is shown if they aren't any of those."] = "單位分類：稀有,稀有精英,精英,首領或爪牙,不包含在這些當中的什麼都不顯示。"
L["Units per column"] = "每行單位數"
L["Units race, Blood Elf, Tauren, Troll (unfortunately) and so on."] = "單位種族，血精靈，牛頭人，食人妖 (被遺忘者)等等。"
L["Units that should have the aura groups settings changed below."] = "單位光環組設定將會如下更變。"
L["Units to change"] = "改變單位"
L["Unknown"] = "未知"
...
L["View"] = "查看"
L["Visibility"] = "可見性"
L["WARNING! ShadowedUF_Indicators has been deprecated as v4 and is now built in. Please delete ShadowedUF_Indicators, your configuration will be saved."] = "警告!ShadowedUF_Indicators組件已於V4版時停用，並已內建。請刪除ShadowedUF_Indicators，你的設定將會繼續保留。"
...
L["What group this aura belongs to, this is where you will find it when configuring."] = "這個光環是屬於什麼組，當你設置的時候你會在這裡找到它"
L["What type of auras should be enlarged, use the scaled aura size option to change the size."] = "什麼類型的光環應放大，使用縮放光環尺寸選項來改變大小。"
...
L["Whether auras you casted should be shown"] = "無論是否你已施放的光環都會顯示"
L["Whether to show any auras casted by the boss"] = "是否要顯示由Boss施放的任何光環"
L["Whether to show any debuffs you can remove, cure or steal."] = "是否要顯示任何你可以驅散，治療或偷取的Debuff(減益)。"
L["Whether to show auras that do not fall into the above categories."] = "是否顯示不屬於上述類別的光環。"
L["Whether to show buffs that you cannot cast."] = "是否要顯示你無法施放的buff(增益)。"
L["Whitelist"] = "白名單"
L["Whitelist filters"] = "白名單篩選"
L["Whitelists"] = "白名單"
L["Widget Size"] = "模組(Widget)大小"
L["Width"] = "寬"
...
L["You can disable aura filters and groups for units here. For example, you could set an aura group that shows DPS debuffs to only show on the target."] = "在這裡你可以禁用光環篩選器和光環組。例如，您可以設置顯示目標光環組只顯示 DPS 的 Debuff(減益)。"
...
L["You can link auras together using this, for example you can link Mark of the Wild to Gift of the Wild so if the player has Mark of the Wild but not Gift of the Wild, it will still show Mark of the Wild as if they had Gift of the Wild."] = "你可以連接到一起使用這個光環，例如你能連結 野性印記 到 野性賜福，那麼如果玩家有 野性印記 但沒有 野性賜福，它仍然會把 野性印記 顯示為就像擁有 野性賜福 一樣。"
