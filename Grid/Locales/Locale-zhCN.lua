...
L["General"] = "通用"
L["Module debugging menu."] = "模块除错菜单"
...
L["Always hide wrong zone groups"] = "总是隐藏错误区域队伍"
...
L["ByGroup Layout Options"] = "以队伍布局选项"
...
L["Show Frame"] = "显示框架"
L["Show groups with all players in wrong zone."] = "全部玩家位于错误区域时显示队伍。"
L["Show groups with all players offline."] = "全部玩家离线时显示队伍。"
L["Show Offline"] = "显示离线"
L["Show tab"] = "显示标签"
L["Solo Layout"] = "单人布局"
L["Spacing"] = "空隙"
